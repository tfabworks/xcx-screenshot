...
## execute `sh ./xcx-screenshot/scripts/stretch3-install.sh`
...
LF=$(printf '\\\012_')
LF=${LF%_}
EXTENSION_NAME=Screenshot
EXTENSION_REP=xcx-screenshot
EXTENSION_ID=screenshot
COLLABORATOR="TFabWorks"
EXTENSION_DESCRIPTION="Save the stage screenshot to the costume."
